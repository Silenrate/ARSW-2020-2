...
public class ControllerTest {
    ...
    public void shouldGetASpecificFunctionOfACinema() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.get("/cinemas/cinemaX/2018-12-18 15:30/SuperHeroes Movie")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(""))
                .andExpect(status().isAccepted());
    }
    ...
    public void shouldNotCreateAnAlreadyExistingCinemaFunction() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/cinemas/cinemaX")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(gson.toJson(getCinemaFunction("SuperHeroes Movie", "Action")))
                        .accept(MediaType.APPLICATION_JSON))
    ...
    public void shouldUpdateACinemaFunction() throws Exception {
        CinemaFunction cinemaFunction = services.getFunctionByMovieName("cinemaX","2018-12-18 15:30","SuperHeroes Movie");
